...
Using batches smaller than 32 samples can introduce a different kind of problem. Having too few data points that don't represent the mean of the data well, may lead to slow and unstable training. I took the maximum batch size that would fit into VRAM which led to sizes between 32 and 64. When using 3D convolutions I was restricted to sizes between 2 and 4 due to their high dimensionalies
