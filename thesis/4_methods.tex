...
To find the right balance between a model that is complex enough to solve the problem and still generalizes well, one has to try different sizes and see what works best. It was noted that models with more than 500,000 parameters tended overfit and train less stable. Different types of regularization technqiues did not solve this. Further architecture tests were made below this parameter count.
...
Using batches smaller than 32 samples
