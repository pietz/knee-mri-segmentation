...
The closing process initializes at the center of the growth plate and extends to the edges.  Literature often classifies the current state of the growth plate in open, centrally-closed and closed \cite{Mauer2015}. They are visible in T1 weighted MRIs as dark regions, whereas the surrounding bone appears bright.
...
\endminipage
\caption{A landscape photograph with a possible semantic segmentation map for sky, stone and sea}
\end{figure}
